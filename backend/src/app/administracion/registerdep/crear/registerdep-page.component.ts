...
@Component({
    selector: 'app-registerdep-page',
    templateUrl: './registerdep-page.component.html',
    styleUrls: ['./registerdep-page.component.scss'],
    providers: [UserService, RolService, EmpresaService, PaisService, ProfesionService]
})



export class RegisterdepPageComponent implements OnInit{
    ...
    constructor(
        ...
        this.departamento = new Departamento('', '', '', '', '', '', '','',true,'');
    }
    ngOnInit() {
 ...
 */        this.getProfesion();
 this.getUserIdentityEmpresa();
    ...
    onSubmit(form){
       ...
       this.departamento.empresa = this.identidadempresa;
       
       console.log('departamento ===========');
       console.log(this.departamento);
       this._userService.registerDep(this.departamento).subscribe(response=>{
