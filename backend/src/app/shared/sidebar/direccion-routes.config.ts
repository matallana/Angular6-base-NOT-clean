...
export const ROUTESDIRECCION: RouteInfo[] = [
...
￼
    ...
    {
        path: '', title: 'Dirección', icon: 'ft-calendar', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            { path: '/administracion/eventos/', title: 'Mi Unidad', icon: 'ft-list', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu:[
                { path: '/administracion/eventos/miunidad', title: 'Ver Eventos', icon: 'icon-note', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            ] },
